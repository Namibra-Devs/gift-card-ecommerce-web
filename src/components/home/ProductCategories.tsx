...
const ProductCategories = () => {
  ...
  return (
    <div className="">
        <div className="flex items-center gap-6 w-full border-b border-greylight px-4 md:px-[255px] pb-6 scrollbar-hide overflow-x-auto -ms-overflow-style: none scrollbar-width: none">
