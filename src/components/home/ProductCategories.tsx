...
const ProductCategories = () => {
  ...
  return (
    <div className="">
        <div className="flex items-center gap-6 w-full border-b border-greylight px-[355px] pb-6 scrollbar-hide overflow-x-auto -ms-overflow-style: none scrollbar-width: none">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-[20px] mt-4 px-[355px]">{product} </section>
    </div>
  )
};
